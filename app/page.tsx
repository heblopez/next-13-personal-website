...
export default async function Home() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-20 px-8">
      <h1 className="text-7xl text-center font-extrabold"> Hi, I&apos;m <span className="bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 bg-clip-text text-transparent">Heberth Lopez</span>!</h1>
